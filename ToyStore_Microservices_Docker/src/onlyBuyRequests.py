...
if __name__ == '__main__':
    ...
    onlyBuyRequests = onlyBuyRequests(numClients, hostName)
    onlyBuyRequests.runClients()

    print('Average Latency per request for each client (ms): ', onlyBuyRequests.requestLatencyArray)
    print('Average latency per request (ms):', onlyBuyRequests.averageLatency)
